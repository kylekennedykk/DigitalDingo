  ...
  return (
    <>
      <SEO 
        ...
        description="Learn about DigitalDingo's mission to blend Australian Indigenous art with modern web design. Meet our team of passionate designers and developers."
        keywords="about digitaldingo, indigenous web design, australian web agency, web design team"
      />

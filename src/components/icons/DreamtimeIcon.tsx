...
interface DreamtimeIconProps extends HTMLAttributes<SVGElement> {
  size?: number
  className?: string
}

export function DreamtimeIcon({ size = 24, className, ...props }: DreamtimeIconProps) {
  return (
    <svg 
      viewBox="0 0 239.25 371.04" 
      width={size} 
      height={size}
